...
public class SignUpPage_Company extends PageBase {
    ...
    private static final By txt_q1 = By.xpath("//p[text()= 'Do you have a company registered in Saudi Arabia?']");
    private static final By btn_q1_Yes = By.xpath("//div[@id=\"registeration_companyRegisterSaudi\"]//child::span[text()=\"Yes\"]");
    private static final By txt_q2 = By.xpath("//p[text()= 'Do you generate SR 3M or more annually in revenue?']");
    private static final By btn_q2_Yes = By.xpath("//div[@id=\"registeration_trendingActivityQuestion\"]//child::span[text()=\"Yes\"]");
    private static final By txt_q3 = By.xpath("//p[text()= 'Has your company been operating for more than 1 year?']");
    private static final By btn_q3_Yes = By.xpath("//div[@id=\"registeration_companyRegisterYear\"]//child::span[text()=\"Yes\"]");
    ...
    private final By depositButton = By.xpath("//button[text() = 'Deposit']");
        ...
        public SignUpPage_Company(WebDriver driver){
            super(driver);
            // super(driver);
            this.driver=driver;
...
//            Assert.assertEquals(false,isSignUpBtnEnabled);
    ...
    public  void verifyAndClickOnCompanyIcon() throws InterruptedException {
         PageBase.doClickOnWebElement(icon_Company,20);
        Thread.sleep(2000);
    }
...
//        PageBase.isElementSelected(checkbox_TermsAndConditions);
    ...
    public  void userGetTheFirstQuestionOnSecondStepOfRegistration(String expectedQ1Text) throws InterruptedException {
       String actualQ1Txt =  PageBase.doGetText(txt_q1);
        System.out.println("First question text as : " + actualQ1Txt);
        Assert.assertEquals(actualQ1Txt,expectedQ1Text,"First question text is mismatched");
        Thread.sleep(2000);
    }
    public  void userGetTheSecondQuestionOnSecondStepOfRegistration(String expectedQ1Text) throws InterruptedException {
        String actualQ2Txt =  PageBase.doGetText(txt_q2);
        System.out.println("Second question text as : " + actualQ2Txt);
        Assert.assertEquals(actualQ2Txt,expectedQ1Text,"Second question text is mismatched");
        Thread.sleep(2000);
    }
    public  void userGetTheThirdQuestionOnSecondStepOfRegistration(String expectedQ1Text) throws InterruptedException {
        String actualQ3Txt =  PageBase.doGetText(txt_q3);
        System.out.println("Third question text as : " + actualQ3Txt);
        Assert.assertEquals(actualQ3Txt,expectedQ1Text,"Third question text is mismatched");
        Thread.sleep(2000);
    }
    public void userClickOnYesButtonForQ1() throws InterruptedException {
        PageBase.doClickOnWebElement(btn_q1_Yes,60);
    }
    public void userClickOnYesButtonForQ2() throws InterruptedException {
        PageBase.doClickOnWebElement(btn_q2_Yes,60);
    }
    public void userClickOnYesButtonForQ3() throws InterruptedException {
        PageBase.doClickOnWebElement(btn_q3_Yes,60);
    }
